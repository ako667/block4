...
/// @title LPVault — ERC-4626 for LP USDC deposits (pmLP) + protocol fee collection
contract LPVault is ERC4626, AccessControl, ReentrancyGuard {
    ...
    constructor(IERC20 asset_, address admin) ERC4626(asset_) ERC20("Prediction Market LP", "pmLP") {
